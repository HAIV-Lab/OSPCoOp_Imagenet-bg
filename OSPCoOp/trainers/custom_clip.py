...
class PromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        n_ctx = cfg.TRAINER.OSPCOOP.N_CTX
        ctx_init = cfg.TRAINER.OSPCOOP.CTX_INIT
        ...
        self.class_token_position = cfg.TRAINER.OSPCOOP.CLASS_TOKEN_POSITION
