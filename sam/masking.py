...
def save_mask_data(imgname, mask_list, box_list, label_list):
    ...
    mask_img = mask_img.astype(np.uint8)  # 转换为 uint8 类型
...
if __name__ == "__main__":
    ...
    id2clsname = read_file_line_by_line("./imagenet/classnames.txt")
    if use_sam_hq:
